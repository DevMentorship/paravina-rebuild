import { ExtLinkOptions, FileOptions, HitOptions, NotBounceOptions } from './ymOptions';
import { FirstPartyParamsParameters, InitParameters, UserParameters, VisitParameters } from './ymParameters';

type InitEventParameters = [eventName: 'init', parameters: InitParameters];

type AddFileExtensionEventParameters = [eventName: 'addFileExtension', extensions: string | string[]];
...
type FirstPartyParamsEventParameters = [eventName: 'firstPartyParams', parameters: FirstPartyParamsParameters];
