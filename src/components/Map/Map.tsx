...
export const Map = () => (
  <section className={cn(styles['wrapper'], 'container')}>
    <div>
      <h3 className={cn(styles['title'], 'heading3')}>Где мы находимся?</h3>
      <p className={cn(styles['desc'], 'paragraph')}>Нашу клинику можно найти по адресу:</p>
      <Link className={styles['link']} href="https://yandex.ru/maps/51/samara/?utm_medium=mapframe&utm_source=maps">
        Самара
      </Link>
      <Link
