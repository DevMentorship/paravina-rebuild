...
export const Tabs = () => (
  <section className="container">
    ...
    <p className={styles.description}>
      Мы предоставляем весь спектр стоматологических и косметологических услуг по демократичным ценам. Профессиональный
      и перспективный коллектив нашей клиники гарантирует высочайшее качество лечения.
    </p>
